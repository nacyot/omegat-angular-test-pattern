...
* [권장하는 설정](#suggested-controller-unit-test-setup-)* 데이터 타입
  * [Anything](#attach-mything-to-the-scope-)
  * [배열(Array)](#attach-myarray-to-the-scope-)
  * [논리값(Boolean)](#attach-myboolean-to-the-scope-)
  * [날짜(Date)](#attach-mydate-to-the-scope-)
  * [메소드(Method)](#attach-mymethod-to-the-scope-)
  * [널(Null)](#attach-mymethod-to-the-scope-)
  * [숫자(Number)](#attach-mynumber-to-the-scope-)
  * [객체(Object)](#attach-myobject-to-the-scope-)
  * [정규표현식(RegExp)](#attach-myregexp-to-the-scope-)
  * [String](#attach-mystring-to-the-scope-)
  * [Undefined](#expect-myundefined-to-be-undefined-)* Method use
  ...
  * [should call method on a service](#call-mymethod-on-myservice-)* Have a good pattern?  * *[pull request welcome!](../#contributing-test-patterns)*
