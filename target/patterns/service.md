...
* [Suggested Setup](#suggested-service-unit-test-setup-)* Data type test patterns
  ...
  * [Undefined](#expect-a-myundefined-to-be-undefined-)* Method use
  * [should return expected value](#mymethod-should-return-expected-value-)* Have a good pattern?  * *[pull request welcome!](../#contributing-test-patterns)*
